...
public class RegistryService {
    ...
    public void getCodelistXML21(@Suspended AsyncResponse response, @PathParam("agencyId") String agencyId, @PathParam("idtype") String id, @PathParam("version") String version, @QueryParam("detail") String detail, @QueryParam("references") String references) {
    ...
    @Produces("application/vnd.sdmx.structure+xml;version=2.1")
    public void getConceptSchemeXML21(@Suspended AsyncResponse response,@PathParam("agencyId") String agencyId, @PathParam("idtype") String id, @PathParam("version") String version, @QueryParam("detail") String detail, @QueryParam("references") String references) {
    ...
    @Produces("application/vnd.sdmx.structure+xml;version=2.1")
    public void getDataStructure21(@Suspended AsyncResponse response,@PathParam("agencyId") String agencyId, @PathParam("idtype") String id, @PathParam("version") String version, @QueryParam("detail") String detail, @QueryParam("references") String references) {
        final StructureType struct = new StructureType();
        StructuresType structures = new StructuresType();
